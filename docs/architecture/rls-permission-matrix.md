...
| `media_assets`                | —          | `R-own`; metadata writes follow the owner media lifecycle     | `R-approved` active creator and company presentation rows (avatar/cover, logo/cover) | `R-approved` active creator and company presentation rows (avatar/cover, logo/cover) | `R-all`, `W-all`            | —                 | —              |
