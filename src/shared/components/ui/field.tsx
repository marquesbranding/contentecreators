...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label has-data-checked:border-primary/30 has-data-checked:bg-primary/5 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 flex w-fit max-w-full gap-2 leading-snug break-words group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5",
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit max-w-full items-center gap-2 text-sm font-medium break-words group-data-[disabled=true]/field:opacity-50",
        className,
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-muted-foreground min-w-0 text-left text-sm leading-normal font-normal break-words group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn(
        "text-destructive min-w-0 text-sm font-normal break-words",
        className,
      )}
      {...props}
    >
