            ...
            {role === "COMPANY" ? (
              <Card className="border-brand-blue/25 bg-brand-blue-soft/35 gap-4 py-5 md:col-span-2">
                <CardHeader className="gap-2 px-5">
                  ...
                  <FieldDescription>
                    Buscaremos os dados oficiais para preencher razão social,
                    nome fantasia e endereço. Você poderá revisar tudo depois.
                  </FieldDescription>
                </CardHeader>
      ...
      >
        {role === "INFLUENCER" ? (
          ...
          <FieldSet>
            ...
            <FieldDescription>
              A sede permanece como localização principal. Os dados sugeridos
              pelo CNPJ continuam editáveis, e você pode cadastrar até nove
              localidades adicionais.
            </FieldDescription>
            <input
              name="additionalLocationsPresent"
              type="hidden"
              value="true"
            />
        ...
        <FieldSet>
          ...
          <FieldGroup className="grid items-end gap-5 md:grid-cols-[1fr_10rem]">
            ...
            <ControlledCombobox
              ...
              placeholder="UF"
              selectedValue={
                role === "COMPANY" ? companyFields.state : undefined
              }
              onValueChange={
                role === "COMPANY"
                  ? (value) =>
