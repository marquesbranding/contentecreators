...
function mapCandidate(
  ...
  return {
    ...
    placement: {
      ...
      linkUrl: row.linkUrl,
      linkOnCreative: row.linkOnCreative,
      showSponsoredBadge: row.showSponsoredBadge,
      showAdvertiserLabel: row.showAdvertiserLabel,
...
function selectCandidates(
  ...
  return database
    .select({
      ...
      linkOnCreative: sponsorshipPlacements.linkOnCreative,
      showSponsoredBadge: sponsorshipPlacements.showSponsoredBadge,
      showAdvertiserLabel: sponsorshipPlacements.showAdvertiserLabel,
      textColor: sponsorshipPlacements.textColor,
      buttonBackgroundColor: sponsorshipPlacements.buttonBackgroundColor,
      buttonTextColor: sponsorshipPlacements.buttonTextColor,
      fontFamily: sponsorshipPlacements.fontFamily,
      imageAlt: sponsorshipPlacements.imageAlt,
