...
function toActivationInput(evidence: SponsorshipActivationEvidence) {
  return {
    ...
    placement: {
      ...
      linkOnCreative: evidence.placement.linkOnCreative,
      showSponsoredBadge: evidence.placement.showSponsoredBadge,
      showAdvertiserLabel: evidence.placement.showAdvertiserLabel,
      textColor: evidence.placement.textColor,
      buttonBackgroundColor: evidence.placement.buttonBackgroundColor,
      buttonTextColor: evidence.placement.buttonTextColor,
      fontFamily: evidence.placement.fontFamily,
      imageAlt: evidence.placement.imageAlt,
      ...
      return runAdminMutation(
        ...
        async (transaction, actor) => {
          ...
          const parsed = parseDraft({
            ...
            linkOnCreative: current.linkOnCreative,
            showSponsoredBadge: current.showSponsoredBadge,
            showAdvertiserLabel: current.showAdvertiserLabel,
            textColor: current.textColor,
            buttonBackgroundColor: current.buttonBackgroundColor,
