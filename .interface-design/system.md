...
- The approved company catalog is a discovery dashboard: a role-specific night hero, horizontally scrollable interest shortcuts, complete URL-owned filters, and a night results board with compact editorial creator cards. Shortcuts never replace the full filter set.
...
| Company discovery dashboard                     | Gives approved companies a fast, campaign-oriented creator browsing surface without inventing participant data | 2026-07-31 |
